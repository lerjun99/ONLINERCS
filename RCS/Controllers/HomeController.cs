...
using static RCS.Controllers.HomeController;
...
namespace RCS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IOptions<Connection> ipsettings)
        {
            _logger = logger;
        ...
        {
            // Define what constitutes a valid date range
            // Example: ignore dates before 1900
        ...
        private bool TryParseDate(string dateString, out DateTime date)
        {
            ...
            // Check if the date is valid according to custom rules
